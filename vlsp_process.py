...
if __name__ == '__main__':
    train_path = 'datasets/1-VLSP2018-SA-Hotel-train.txt'
    val_path = 'datasets/2-VLSP2018-SA-Hotel-dev.txt'
    test_path = 'datasets/3-VLSP2018-SA-Hotel-test.txt'
    vlsp_hotel_parser = VLSP2018Parser(train_path, val_path, test_path)
